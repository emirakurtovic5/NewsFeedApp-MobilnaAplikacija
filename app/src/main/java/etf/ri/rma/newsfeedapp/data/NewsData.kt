...
object NewsData {
    fun getAllNews(): List<NewsItem> {
        return listOf(
            ...
            NewsItem("3", "Nauka01 Title01 001", "Snippet jklmnopqr", null, "Nauka/tehnologija", false, "Source 3", "2023-01-03"),
            ...
            NewsItem("10", "Politika04 Title04 004", "Snippet ihgfedcba", null, "Politika", true, "Source 10", "2023-01-10"),
